...
const introduction = "일차의료 만성질환관리 사업은 국민건강보험공단에서 진행하는 사업으로, 고혈압과 당뇨병 환자들에게 지속적이고 포괄적인 관리를 제공하는 것을 목표로 하고 있습니다. 해당 사업은 동네의원을 중심으로 환자별 맞춤형 연간 관리 계획을 수립하고, 의사와 케어코디네이터(간호사 또는 영양사, 선택 가능한 인력)로 구성된 팀이 환자의 자기관리 능력을 강화하는 것을 지원합니다.\n" +
    "\n" +
    "일차의료 만성질환관리 사업에 참여하면 원장님은 ‘만성질환 통합관리료’를 통해 추가적인 수익을 창출할 수 있습니다. 예를 들어, 환자 1인당 연간 약 30만 원의 수가를 청구할 수 있으며, 500명의 환자를 관리할 경우 연간 약 1억 5,000만 원의 수익을 기대할 수 있습니다. 또한, 기존 본인부담률이 30%에서 20%로 낮아지고 건강생활실천지원금이 제공되기 때문에 사업에 대한 진입장벽이 낮아졌습니다.\n" +
    "\n" +
    "원장님의 주요 역할은 환자의 건강상태를 평가하고 개인별 맞춤형 관리 계획을 수립하는 것입니다.\n" +
    "이후 환자들에게 질환 관리에 대한 체계적인 교육과 상담을 제공하며, 간호사와 영양사 등과 협력하여 팀 기반의 포괄적인 관리를 진행하는 것입니다.\n" +
    "\n" +
    "일만사업에 참여하신다면 원장님께서는 새로운 수익 창출의 기회가 되는 동시에, 환자의 건강을 증진시키고 의원의 진료 효율성을 높일 수 있습니다. 더불어, 지역사회에 대한 사회적 책임을 다하는 의료기관으로 인정받을 수 있습니다."
