...
const faqList: FAQModel[] = [
  ...
  {
    question: "저희 의원은 원장선생님이 1명이에요. 솔루션 사용이 가능할까요?",
    answer: "저희 솔루션을 사용하는 의원 중 30%는 케어코디네이터 없이 원장님 혼자 병원을 운영하고 계십니다. 초기에는 환자 수가 적었더라도, 솔루션을 통해 꾸준히 등록 환자를 늘리며 안정적으로 운영하고 계십니다. 원장님 혼자서도 병원 운영이 충분히 가능하다는 점을 보여주는 사례입니다."
  },
  {
    question: "저희 의원은 원장선생님이 2명 이상이에요. 솔루션 사용이 가능할까요?",
    answer: "네, 가능합니다.\n" +
        "\n" +
        "저희 솔루션을 사용하는 의원 중 20%는 원장님이 2명 이상 근무하고 계십니다. 이런 경우, 효율적인 정보 정리와 관리가 무엇보다 중요합니다. 아임파인을 통해 필수 업무를 손쉽게 관리하며, 여러 원장님이 함께 운영하는 의원에서도 체계적인 운영을 지원합니다."
  },
  {
